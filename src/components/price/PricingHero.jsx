...
function PricingHero() {
    return (
       <section className="pricing-bg p-5 md:p-14 block md:flex gap-10 mt-10 rounded-3xl mx-4 md:mx-0">
            ...
            <div className="w-full p-0 md:p-5 flex justify-center items-center">
                <div className="h-fit md:h-[350px] w-full md:w-2/4 bg-blue-300 px-4 py-7 rounded-xl relative">
                    ...
                    <div className="p-2 bg-blue-700 text-center rounded-xl ">
                        <p className="text-md border-[1px] border-solid border-gray-400 py-3 rounded-xl px-1 md:px-0 text-white font-semibold">SAVE UP TO <span className="text-xl font-bold">$25,500</span></p>
